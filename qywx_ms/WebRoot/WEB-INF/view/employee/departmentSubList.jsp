...
<body class="backcolor">
	...
	<div
		class="mm-navbar mm-navbar-top mm-navbar-top-2 mm-navbar-size-1 mm-hasbtns">
		<a class="mm-prev mm-btn" onclick="back()" style="width: 10px;"></a> 
		<a class="mm-title" onclick="back()" style="font-size: 1.5em; color: rgba(0,0,0,0.7);">${departmentName }</a>
	</div>
	<div class="mm-panels">
		<div class="mm-panel mm-opened mm-current" id="mm-0">
			<ul class="listview-icons mm-listview">
				...
				<c:if test="${data.childNum != null && data.childNum > 0}">
					<a class="mm-next mm-fullsubopen" href="${ctx_path }/cp/employee/getDepartment.do?departmentId=${data.departmentId }&departmentName=${data.departmentName}&childNum=${data.childNum }&supportedLoginName=${supportedLoginName }&supportedUserName=${supportedUserName }&belongDepartmentId=${belongDepartmentId}&belongDepartmentName=${belongDepartmentName}"></a>
			    </c:if>
