...
<div class="workform_list">
   ...
   <div class="clear"></div>
	...
	<div class="workform_list">
	    <label>客户:</label>
	    <span>${taskbean.installAndRemoveDeviceModel.customerName}
	    </span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	...
	<div class="workform_list">
	    <label>安装类型:</label>
	    <span>${taskbean.installAndRemoveDeviceModel.installType}
	    </span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>安装方式:</label>
	    <span>${taskbean.installAndRemoveDeviceModel.installModel}
	    </span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>省份:</label>
	    <span>${taskbean.installAndRemoveDeviceModel.province}
	    </span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>城市:</label>
	    <span>${ taskbean.installAndRemoveDeviceModel.city}
	    </span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>装机属性:</label>
	    <span>${taskbean.installAndRemoveDeviceModel.installProperty}
	    </span>
	    <div class="clear"></div>
	</div>
	...
	<div class="workform_list">
	    <label>操作系统:</label>
	    <span>${taskbean.installAndRemoveDeviceModel.operationSystem}
	    </span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	...
	<div class="workform_list">
	    <label>atmc名称:</label>
	    <span>${taskbean.installAndRemoveDeviceModel.ATMCName}
	    </span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	...
	<div class="workform_list">
	    <label>加密方式:</label>
	    <span>${taskbean.installAndRemoveDeviceModel.encryptModel}
	    </span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	...
	<div class="workform_list">
	    <label>日均交易金额:</label>
	    <span>${taskbean.installAndRemoveDeviceModel.dailyAverageAmount}
	    </span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>日均交易笔数:</label>
	    <span>${taskbean.installAndRemoveDeviceModel.dailyAverageNum}
	    </span><div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>灰尘:</label>
	    <span>${taskbean.installAndRemoveDeviceModel.dust}
	    </span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>温度:</label>
	    <span>${taskbean.installAndRemoveDeviceModel.temperature}
	    </span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>湿度:</label>
	    <span>${taskbean.installAndRemoveDeviceModel.humidity}
	    </span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>供电:</label>
	    <span>${taskbean.installAndRemoveDeviceModel.powerSupply}
	    </span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>防雨:</label>
	    <span>${taskbean.installAndRemoveDeviceModel.waterproof}
	    </span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
