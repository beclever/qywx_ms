...
<div class="workform_list">
    ...
    <span>${taskbean.installAndRemoveDeviceModel.customerName}
        <%-- <select class="taskOrder_inputwidth" name="YJKTcustom" disabled="disabled">
...
<div class="workform_list">
    <label>安装类型:</label>
    <span>
        <%-- <select class="taskOrder_inputwidth" name="YJKTinstallType" disabled="disabled">
...
<div class="workform_list">
    <label>安装方式:</label>
    <span>
    <%-- <select class="taskOrder_inputwidth" name="YJKTinstallModels" disabled="disabled">
...
<div class="workform_list">
    <label>城市:</label>
    <span>
        <!-- <select class="taskOrder_inputwidth" id="yjktcity" name="YJKTcitys" disabled="disabled">
        </select> -->
...
<div class="workform_list">
    <label>操作系统:</label>
    <span>
        <%-- <select class="taskOrder_inputwidth" name="YJKToperationSystems" disabled="disabled">
...
<div class="workform_list">
    <label>atmc名称:</label>
    <span>
        <%-- <select class="taskOrder_inputwidth" name="YJKTATMCNs" disabled="disabled">
...
<div class="workform_list">
    <label>加密方式:</label>
    <span>
        <%-- <select class="taskOrder_inputwidth" name="YJKTencryptModels" disabled="disabled">
        ...
        ${taskbean.taskAttributeOption.encryptMode.defaultName}
    </span>
    <div class="clear"></div>
</div>
<div class="workform_list">
