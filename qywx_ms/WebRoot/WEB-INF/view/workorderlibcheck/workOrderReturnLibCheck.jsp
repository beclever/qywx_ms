...
<body>
	...
	<div style="width: 90%;margin: 4%" >
		<span style="width: 100%;" align="center"> <textarea
				name="paperRemark" cols="" rows=""
				class="work_task_order_row_textarea" id="result_text"
				style="width: 100%;" align="center"></textarea>
		</span>
	</div>
	<div class="box" align="center" style="margin-top: 20px">
		<input class="window_btn" type="button" value="确定"
			onclick="orderReturnOK()" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
			class="window_btn" type="button" value="取消"
			onclick="orderReturnCancel()">
	</div>
</body>
</html>
