...
<div class="mian02">
	<div class="workform_list">
	    <label>完成情况:</label>
	    <span>
	        &nbsp;${taskbean.installAndRemoveDeviceModel.workIsFinish}
	    </span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
...
<div class="workform_list">
   ...
   <div class="clear"></div>
	...
	<div class="workform_list">
	    <label>atmc名称:</label>
	    <span>&nbsp;${taskbean.installAndRemoveDeviceModel.ATMCName}</span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>atmc版本:</label>
	...
	<div class="workform_list">
	    <label style="width:50%;">atmc跨平台sp:</label>
	    <span style="width:50%;">
	...
	<div class="workform_list">
	    <label>加密方式:</label>
	    <span> &nbsp;${taskbean.installAndRemoveDeviceModel.encryptModel}</span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>atmc号:</label>
	...
	<div class="workform_list">
	    <label style="width:45%;">支行终端号:</label>
	    <span style="width:55%;">
	...
	<div class="workform_list">
	    ...
	    <span style="width:55%;">&nbsp;${taskbean.installAndRemoveDeviceModel.dailyAverageNum}</span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label style="width:45%;">日均交易笔数:</label>
	    <span style="width:55%;">&nbsp;${taskbean.installAndRemoveDeviceModel.dailyAverageAmount}</span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>灰尘:</label>
	    <span>&nbsp;${taskbean.installAndRemoveDeviceModel.dust}</span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>温度:</label>
	    <span>&nbsp;${taskbean.installAndRemoveDeviceModel.temperature}</span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>湿度:</label>
	    <span>&nbsp;${taskbean.installAndRemoveDeviceModel.humidity}</span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>供电:</label>
	    <span>&nbsp;${taskbean.installAndRemoveDeviceModel.powerSupply}</span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>防雨:</label>
	    <span>&nbsp;${taskbean.installAndRemoveDeviceModel.waterproof}</span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>日晒:</label>
	    <span>&nbsp;${taskbean.installAndRemoveDeviceModel.solarization}</span>
	    <div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>安装地址:</label>
	    <span>&nbsp;${taskbean.installAndRemoveDeviceModel.installAddress}
	    </span><div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>参考费用:</label>
	    <span>&nbsp;${taskbean.installAndRemoveDeviceModel.referenceCharge}
	    </span><div class="clear"></div>
	</div>
	<div class="workform_list">
	    <label>参考线路:</label>
	    <span>&nbsp;${taskbean.installAndRemoveDeviceModel.consultWay}
	    </span>
	    <div class="clear"></div>
	</div>
</div>