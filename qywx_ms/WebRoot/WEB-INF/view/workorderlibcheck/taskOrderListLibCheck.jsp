...
<body>
	...
	<!-- 隐藏域 -->
	<input type="hidden" value="<%=basePath%>" id="urls">
	...
	<div id="taskOrder_nav">
		<ul style="padding-bottom:3em;">
			<!-- <li><a id="DATETIME" href="javascript:void(0)"><span
					class="min_width">时间</span></a></li>-->
			...
			<c:forEach items="${tasklist}" var="taskbean">
				...
				<c:if test="${taskbean.taskType=='QT'}">
					<div class="tagContent selectTag flowmargin-top"
						...
						<%@ include file="task_qt_lib_check.jsp"%>
					</div>
				</c:if>
				...
				<c:if test="${taskbean.taskType=='YJKT'}">
					<div class="tagContent selectTag flowmargin-top"
						id="${taskbean.taskType}Div" style="display: none;">
						<%@ include file="task_yjkt_lib_check.jsp"%>
					</div>
				</c:if>
				...
				<c:if test="${taskbean.taskType=='PX'}">
					<div class="tagContent selectTag flowmargin-top"
						id="${taskbean.taskType}Div" style="display: none;">
						<%@ include file="task_khpx_lib_check.jsp"%>
					</div>
				</c:if>
				...
				<c:if test="${taskbean.taskType=='ZW'}">
					<div class="tagContent selectTag flowmargin-top"
						id="${taskbean.taskType}Div" style="display: none;">
						<%@ include file="task_zwcl_lib_check.jsp"%>
					</div>
				</c:if>
				...
				<c:if test="${taskbean.taskType=='YJFZ'}">
					<div class="tagContent selectTag flowmargin-top"
						id="${taskbean.taskType}Div" style="display: none;">
						<%@ include file="task_yjfz_lib_check.jsp"%>
					</div>
				</c:if>
				...
				<c:if test="${taskbean.taskType=='AZFZ'}">
					<div class="tagContent selectTag flowmargin-top"
						id="${taskbean.taskType}Div" style="display: none;">
						<%@ include file="task_azfz_lib_check.jsp"%>
					</div>
				</c:if>
				...
				<c:if test="${taskbean.taskType=='AZKT'}">
					<div class="tagContent selectTag flowmargin-top"
						id="${taskbean.taskType}Div" style="display: none;">
						<%@ include file="task_azkt_lib_check.jsp"%>
					</div>
				</c:if>
				...
				<c:if test="${taskbean.taskType=='WX'}">
					<div class="tagContent selectTag flowmargin-top"
						id="${taskbean.taskType}Div" style="display: none;">
						<%@ include file="task_wx_lib_check.jsp"%>
					</div>
				</c:if>
				<!-- 巡检 -->
				<c:if test="${taskbean.taskType=='XJ'}">
				<input type="hidden" value="${taskbean.taskId}" id="XJ${taskbean.taskId}taskId">
					<div class="tagContent selectTag flowmargin-top"
						...
						<%@ include file="task_xj_lib_check.jsp"%>
					</div>
				</c:if>
				...
				<c:if test="${taskbean.taskType=='BY'}">
					...
					<div class="tagContent selectTag flowmargin-top"
						id="${taskbean.taskType}Div" style="display: none;">
						<%@ include file="task_by_lib_check.jsp"%>
					</div>
				</c:if>
			</c:forEach>
			...
			<c:forEach items="${gradelist}" var="gradebean" varStatus="stas">
				<div class="tagContent selectTag flowmargin-top"
					...
					<div class="mian02">
						...
						<div class="workform_list">
							<label><font color="red">*</font>耗时(分钟):</label> <span>${gradebean.costTime}</span>
							<div class="clear"></div>
						</div>
						<div class="workform_list">
	...
	<script type="text/javascript" src="${ctx_path }/pub/js/page/workorderlibcheck/taskOrderListLibCheck.js"></script>
</body>
</html>