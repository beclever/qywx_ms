...
@WebService
public interface SocWorkFormEngine {
    
    
    //5.2.11.   工单管理-获取待处理工单列表接口
    public WsResultPendingWorkFormBean getPendingWorkForm(String loginCode,WsPage wsPage,String clientType);
        
    
    public WsResultBean createWorkform(WsWorkFormBean wsWorkFormBean);
    /**
     * 创建工单
     ...
     * @return
     */
    public WsResultBean createWorkformInfo(WsWorkFormBean wsWorkFormBean,String clientType);
    
    public WsResultBean cancelWorkform(String poNumber);
     ...
     * @return
     */
    public WsResultBean cancelWorkformInfo(String poNumber,String checkUserCode,String clientType);
     ...
     * @return
     */
    public WsResultBean addWorkTaskInfo(String poNumber,List<WsWorkTaskBean> wsWorkTaskBean,String createUserCode,String clientType);
     ...
     * @return
     */
    public WsResultBean deleteWorkTaskInfo(String poNumber,List<WsWorkTaskBean> wsWorkTaskBean,String createUserCode,String clientType);
     ...
     * @return
     */
    public WsResultBean doUpdateAppointmentDateInfo(String checkLongName,String workFormId,String appointmentDate,String clientType);
     ...
     * @return 目标仓库
     */
    public WsResultBean checkWorkformStepInStore(String poNumber,String arriveTime,String workStartDate,String workFinishDate,String buttonType,String checkUserCode,String checkRemark,String targetStoreId);
     ...
     * @return
     */
    public WsResultBean checkWorkformStepInStoreInfo(String poNumber,String arriveTime,String workStartDate,String workFinishDate,String buttonType,String checkUserCode,String checkRemark,String targetStoreId,String clientType);
     ...
     * @return
     */
    public WsResultBean checkWorkformStepInStoreInfoForCSS(String poNumber,String reportTime, String appointmentDate, String arriveTime,String workStartDate,String workFinishDate,String buttonType,String checkUserCode,String checkRemark,String targetStoreId,String clientType);
    /**
     * 工单退回
     * @param poNumber 工单号
     ...
     * @return
     */
    public WsResultBean doWriteWorkFormProcessInfo(String poNumber,String writeUserCode,String writeMessage,String clientType);
    ...
    public WsResultBean addFollowEngineer(String poNumber,List<String> followEngineerCodeList);
    ...
    public WsResultBean checkWorkFormInfo(String serialNumber,String types);
    ...
    //AOC任务移除接口
    //public String doDeleteTask(String taskId);
    
    public WsResultBean doDeleteTask(String poNumber,String taskId, String createUserCode, String clientType);
    ...
    * 获取用户借用(不含待归还)备件清单
    */
   public List<WsBorrowInfoBean> findBorrowInfoList(String createUserCode,String[] moduleLevels,Integer workformId,String clientType);
