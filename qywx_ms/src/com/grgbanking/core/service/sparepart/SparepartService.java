package com.grgbanking.core.service.sparepart;
...
public interface SparepartService {
    ...
    WsBorrowDetailBean findBorrowInfoDetailList(String loginName,
            WsPage page,String operateType, String clientType) throws Exception;
     ...
     * @return
     */
    public WsResultAocReviewBorrowBean aocFindToReviewBorrowInfoList(
            String loginName, WsPage page, String clientType);
